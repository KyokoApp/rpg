...
- **Pencahayaan & bayangan halus** — shadow map PCF-soft 2048² real-time; bola & benteng melempar bayangan lunak ke tanah. **Satu arah matahari** (`SUN_DIR`) jadi sumber kebenaran: cahaya directional, piringan/halo matahari yang terlihat, shading toon, dan arah bayangan semuanya konsisten — bayangan jatuh berlawanan dengan posisi matahari.
- **Awan anime toon** — gumpal karton putih dengan **kontur gelap** yang selalu menghadap kamera (billboard) dan hanyut pelan, khas gaya anime/Ghibli.
